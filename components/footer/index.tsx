...
export default function Footer() {
  const pages = [
    { title: 'Search', href: '/restaurants' },
    { title: 'Discover', href: '/restaurants' },
    {
      title: 'Hospitality',
  ...
  return (
    <Link
      ...
      <Image
        ...
        height={30}
      />
      <span className='font-medium text-black dark:text-white'>Gluten-Free Thailand</span>
    </Link>
  )
}
